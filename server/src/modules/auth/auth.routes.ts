...
const refreshBodySchema = z.object({ refreshToken: z.string().optional() }).optional().default({});
...
router.post('/exchange', validate({ body: exchangeBodySchema }), asyncHandler(controller.exchange));
